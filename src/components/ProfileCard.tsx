...
export default class ProfileCard extends React.Component<any, any> {
  ...
  public render() {
    return (
      <Card fluid>
        <Image src={profileImg[this.props.id + '_img'].img}
               onMouseOver={(e) => {
                 if (profileImg[this.props.id + '_img'].hover) {
                   e.target.src = profileImg[this.props.id + '_img'].hover;
                 }
               }}
               onMouseOut={(e) => {
                 if (profileImg[this.props.id + '_img'].hover) {
                   e.target.src = profileImg[this.props.id + '_img'].img;
                 }
               }}
        />
        <Card.Content>
